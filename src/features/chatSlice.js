...
//The action object typically has two properties: type: A string that
//indicates the type of action being performed.
//payload: The data associated with the action. In the case of async
//thunk actions, the payload is usually the response returned by the API call.
